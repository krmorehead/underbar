(function() {
  ...
  _.map = function(collection, iterator) {
    ...
    var results = []
    _.each(collection, function(el){results.push(iterator(el))})
    return results
  };
  ...
  _.extend = function(obj) {
    _.reduce(arguments,function(accumulator, properties){

      _.each(properties,function(el, key){
        obj[key] = el
      })
      return obj
    })
  ...
  _.delay = function(func, wait) {
    var argumentsArray = []
    _.each(arguments, function(el){argumentsArray.push(el)})
  ...
  _.shuffle = function(array) {
    ...
    _.each(arrayCopy, function(el, idx){
      var randIdx = Math.floor(Math.random() * arrayCopy.length);
      var otherEl = arrayCopy[randIdx];
